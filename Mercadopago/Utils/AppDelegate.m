...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    HomeViewControllerTableViewController * home = [[HomeViewControllerTableViewController alloc] init];
    ...
    self.nav.navigationBar.prefersLargeTitles = YES;
    
    self.nav.navigationBar.tintColor = UIColor.whiteColor;
    
    self.nav.navigationBar.barTintColor = [UIColor colorWithRed:0.0 green:(153.0/255.0) blue:(223.0/255.0) alpha:1.0];
